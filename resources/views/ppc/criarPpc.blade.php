        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container mt-5">
                ...
                <div class="text-center mb-4">
                    <h2 class="font-weight-bold text-primary">Criar Novo PPC</h2>
                </div>

                <!-- Formulário -->
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('criarPpc') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="limite_horas" name="limite_horas" placeholder="Ex: 60" required>
                            </div>
