        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container mt-5">
                ...
                <div class="text-center mb-4">
                    <h2 class="font-weight-bold text-primary">Anexar Novo Certificado</h2>
                </div>

                <!-- Formulário -->
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('criarCertificado', $submissao_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="submissao_id" value="{{ $submissao_id ?? '' }}">
                            <div class="form-group">
                                <label for="titulo">Título do Certificado</label>
                                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ex: Curso de HTML e CSS" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="imagem">Imagem do Certificado</label>
                                <input type="file" class="form-control-file" id="imagem" name="img" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="total_horas">Total de horas do Certificado</label>
                                <input type="number" class="form-control" id="total_horas" name="total_horas" placeholder="Ex: 40" required>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href={{ route('login') }}>Sair</a>
                </div>
            </div>
        </div>
    </div>
