        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <a href="{{ route('verSubmissoes', Auth::id()) }}" class="btn btn-secondary mt-3 ml-2">
                        <i class="fas fa-eye mr-1"></i> Ver Submissões Avaliadas
                    </a>
                ...
                <div class="container mt-5">
                    ...
                    <div class="text-center mb-4">
                        <h2 class="font-weight-bold text-primary">Painel do Avaliador</h2>
                        <h6 class="font-weight-bold text-primary">Submissões pendentes de avaliação</h6>
                    </div>
                            ...
                            <div class="card shadow mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a href="{{ route('verSubmissao', $submissao->id) }}" class="btn btn-info btn-sm">
                                                <i class="fas fa-eye mr-1"></i> Avaliar submissao
                                            </a>
                                        </div>
                                    </div>
                                </div>
